...
class Books(db.Model):
    ...
    Book_Image = db.Column(db.String(100), unique=True, nullable=False)
...
class Anime(db.Model):
    ...
    Anime_Image = db.Column(db.String(100), unique=True, nullable=False)
...
class Games(db.Model):
    ...
    Game_Image = db.Column(db.String(100), unique=True, nullable=False)
